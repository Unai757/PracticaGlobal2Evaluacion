...
Es un programa para administrar conciertos, artistas y entradas. Permite guardar datos nuevos, borrar los que ya no necesites y ver toda la información guardada en una base de datos de Oracle.
...
El código está separado en varias clases para que sea más fácil de entender y arreglar:
...
## Cómo usarlo
1. **Ejecutar**: Abre el proyecto en tu IDE que uses (como IntelliJ o Eclipse) y dale al botón de la flecha verde para empezar.
